...
<div class="flex flex-wrap items-start justify-between gap-3 mb-6 fade-up">
    <div>
        ...
        <p class="text-sm mt-1" style="color:var(--text-2)">Administra tu información y tus fotos</p>
    </div>
    <div class="flex items-center gap-2 flex-wrap">
        ...
        <a href="{{ route('perfil.publico', $user) }}" target="_blank"
           class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold no-underline transition-all hover:opacity-80"
